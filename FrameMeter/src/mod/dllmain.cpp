...
{
	const bool play_frame = !is_training_mode() || !frame_by_frame || (just_pressed(VK_F6) || was_held(VK_F6));
...
bool check_game_version()
{
	...
	wcscpy_s(game_version, sizeof(game_version), (wchar_t *)((char *)module_info.lpBaseOfDll + 0x04743F00));
